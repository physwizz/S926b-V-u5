...
static struct dump_expect s6e3haf_e2s_self_mask_checksum_expects[] = {
	{ .offset = 0, .mask = 0xFF, .value = 0x85, .msg = "Self Mask CHKSUM[0] Error(NG)" },
	{ .offset = 1, .mask = 0xFF, .value = 0xA1, .msg = "Self Mask CHKSUM[1] Error(NG)" },
	{ .offset = 2, .mask = 0xFF, .value = 0x1E, .msg = "Self Mask CHKSUM[2] Error(NG)" },
	{ .offset = 3, .mask = 0xFF, .value = 0x43, .msg = "Self Mask CHKSUM[3] Error(NG)" },
};
