...
MODEL_VARIANT_MODULE_LIST = [
    ...
    "drivers/media/platform/exynos/camera/sensor/module_framework/cis/is-cis-gn3-flip.ko",
    "drivers/media/platform/exynos/camera/sensor/module_framework/cis/is-cis-3j1.ko",
    "drivers/media/platform/exynos/camera/sensor/module_framework/cis/is-cis-3lu-dphy.ko",
