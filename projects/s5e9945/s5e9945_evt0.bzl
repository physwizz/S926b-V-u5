...
load("//kernel:kunit.bzl", "kunit_module_list")
...
load(":s5e9945_model_variant_modules.bzl", "MODEL_VARIANT_MODULE_LIST")
load(
    ":s5e9945_evt0_modules.bzl",
...
def define_s5e9945_evt0_kernel(
        name,
        outs = None,
        build_config = None,
        module_outs = None,
    ...
    native.filegroup(
        ...
        srcs = [":build.config.s5e9945_evt0.common"],
    )
    ...
    _exynos_vendor_boot_list = VENDOR_MODULE_LIST + lego_module_list + kunit_module_list + MODEL_VARIANT_MODULE_LIST
    ...
    if "abi" in name:
        ...
        kernel_build(
            ...
            build_config = ":build.config.s5e9945_evt0_user",
    ...
    native.filegroup(
        ...
        srcs = [ "//prebuilts/platform/common:fstab.s5e9945",
                 ...
                 "//prebuilts/platform/erd9945:firmware/sgpu/vangogh_lite_unified_evt0.bin",
