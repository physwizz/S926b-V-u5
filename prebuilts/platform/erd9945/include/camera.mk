...
ifneq ($(filter mu1s% mu2s% mu3s% e1s% e2s% e3s% b6s% r12s% b7r%, $(TARGET_PRODUCT)),)
PRODUCT_PACKAGES += \
...
PRODUCT_COPY_FILES += \
    ...
    device/samsung/erd9945/external_camera_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/external_camera_config.xml
